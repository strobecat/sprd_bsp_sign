...
ifeq ($(strip $(USE_DEBUGMASK_32)),true)
LOCAL_CFLAGS += -DDEBUGMASK_32
endif
...
$(shell cp -rf $(HOST_OUT_EXECUTABLES)/sprd_mkprimarycert $(dest_path)/sprd_mkprimarycert)
$(shell chmod +x $(dest_path)/sprd_mkprimarycert)
