...
int main (int argc,char *argv[])
{
   ...
   */
    ...
    read_len = fread(header_buf,1,sizeof(sys_img_header),fplaintext);/*get the magic and mImgSize from sys_img_header*/
    if (read_len < sizeof(sys_img_header)) {
        printf("read sys_img_header failed! \n");
        exit(-1);
    }
